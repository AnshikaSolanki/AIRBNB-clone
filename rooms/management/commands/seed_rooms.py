...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--number",default=2, type=int, help="how many times should i tell?")
    ...
    def handle(self, *args, **options):
        ...
        for pk in created_clean:
            ...
            for i in range(3, random.randint(10,24)):
        ...
        self.stdout.write(self.style.SUCCESS(f'{number} facilities created!'))